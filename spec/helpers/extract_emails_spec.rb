...
describe 'String#extract_emails' do
  ...
  context "valid" do
    it "extracts single email from: pablo@colcentric.com" do
      should == %w[ pablo@colcentric.com ]
    end
    ...
    it "extracts header-style emails from: 'Pablo' <pablo2@colcentric.com>, 'Juan Jaramillo'" do
      should == %w[ pablo2@colcentric.com ]
    end
    ...
    it "handles plus-addressing from: ohyeah+colcentric@gmail.com" do
      should == %w[ ohyeah+colcentric@gmail.com ]
    end
