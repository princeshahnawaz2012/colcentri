...
describe HtmlFormatting, 'Should apply our special Markdown' do
  ...
  it "she@couchsurfing.org used to mean so much to www.colcentric.com" do
    should == "<p><a href=\"mailto:she@couchsurfing.org\">she@couchsurfing.org</a> used to mean so much to <a href=\"http://www.colcentric.com\">www.colcentric.com</a></p>"
  end
  ...
  it 'Did you know the logo from colcentric has <a href="http://en.wikipedia.org/wiki/Color_theory">carefully selected colors</a>? <img src="http://app.colcentric.com/images/header_logo_large.jpg"/>' do
    should == %Q{<p>Did you know the logo from colcentric has <a href="http://en.wikipedia.org/wiki/Color_theory">carefully selected colors</a>? <img src="http://app.colcentric.com/images/header_logo_large.jpg" /></p>}
  end

  it 'This commit needs a spec: http://github.com/colcentric/colcentric/blob/4b54c555d118cd3bc4d4d80fbc59b1eed79b4e80/lib/html_formatting.rb' do
    should == "<p>This commit needs a spec: <a href=\"http://github.com/colcentric/colcentric/blob/4b54c555d118cd3bc4d4d80fbc59b1eed79b4e80/lib/html_formatting.rb\">http://github.com/colcentric/colcentric/blob/4b54c555d118cd3bc4d4d80fbc59b1eed79b4e...</a></p>"
  end

  it 'This commit needs a spec: http://github.com/colcentric/colcentric/commit/4b54c555d118cd3bc4d4d80fbc59b1eed79b4e8' do
    should == "<p>This commit needs a spec: <a href=\"http://github.com/colcentric/colcentric/commit/4b54c555d118cd3bc4d4d80fbc59b1eed79b4e8\">http://github.com/colcentric/colcentric/commit/4b54c555d118cd3bc4d4d80fbc59b1eed79b4e8</a></p>"
  end
