Colcentric::Application.configure do
  ...
  #   "http://#{Colcentric.config.app_domain}", "https://#{Colcentric.config.app_domain}"
  # )
  ...
  config.action_mailer.default_url_options = {:host => Colcentric.config.app_domain}
