module UsersHelper
  ...
  def js_for_signup_form_validations
    ...
    document.on('change', '#user_first_name, #user_last_name, #user_phone, #user_company_name, #user_company_members, #user_country', function(e,input) {
    ...
    document.on('change', '#user_phone', function(e, input){
  ...
  def show_terms_of_use
    link_to content_tag(:span,t('project_groups.fields.forever')),
