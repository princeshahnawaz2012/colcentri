class ProjectsController < ApplicationController
  ...
  before_filter :check_project_archived, :only => [ :show ]
  ...
  def create
    ...
    respond_to do |f|
      if @project.save
        ...
        f.m { redirect_to show_all_project_groups }
      else
  ...
  protected
    ...
    def disallow_for_community
      if @community_organization && (@community_role.nil? || Membership::ROLES[@community_role] < 20)
