class User
  ...
  def is_active?
    Colcentric.config.email_confirmation_require ? self.confirmed_user : true
  end


  # Old version
  def subscription_active?
    self.subscription && ((self.subscription.is_active? and not self.subscription.trial?) || (self.subscription.trial?) || (self.subscription.special?))
