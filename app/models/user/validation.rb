class User
  ...
  validates_acceptance_of :terms_of_use, :accept => true, :message => "must be checked"



  #validates_each :terms_of_use do |model, attr, value|
   # unless [nil,"yes"].include?(value)
   #   model.errors.add(attr, "must be checked")
   # end
  #end

 # def accept_terms_of_use
  #  errors.add(:terms_of_use, 'must be checked') unless terms_of_use?
  #end
