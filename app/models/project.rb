...
class Project < ActiveRecord::Base
  ...
  concerned_with :validation,
                 ...
                 :invitations,
                 :conversions
                 #:personalization Not used now, maybe in the future

  attr_accessible :name, :permalink, :archived, :tracks_time, :public, :organization_attributes, :organization_id, :project_group_id, :personalization
  has_many :google_docs
  has_many :upload_directories
  has_many :forms
  ...
  protected
    ...
    def self.calendar_for_tasks(tasks, projects, filter_user, host = nil, port = 80)
      ...
      ical.product_id = "-//Colcentric//iCal 2.0//EN"
