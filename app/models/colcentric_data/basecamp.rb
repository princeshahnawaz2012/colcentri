class ColcentricData
  ...
  # colcentric data properties. Importers for each different dump are required to
  # convert their representations to colcentric data.
  ...
  def unserialize_basecamp(object_maps, opts={})
    ...
    unserialize_colcentric(import_data, object_maps, opts)
  end
