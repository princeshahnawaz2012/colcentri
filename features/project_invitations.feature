...
Feature: Invite a user to a project
  ...
  Background:
    ...
    And a confirmed user exists with login: "mislav", first_name: "Mislav", last_name: "Marohnić", email: "mislav@colcentric.com"
    And a confirmed user exists with login: "pablo", first_name: "Pablo", last_name: "Villalba", email: "pablo@colcentric.com"
  ...
  Scenario: User creates account and joins project from invitation
    ...
    When "ed_bloom@spectre.com" opens the email with subject "Ruby Rockstars"
    And they should see "Mislav Marohnić wants to collaborate with you on Colcentric" in the email body
  ...
  Scenario: Mislav is invited to a project by someone else
    Given I am logged in as @mislav
    And there is a project called "Colcentric Roulette"
    When I go to the page of the "Colcentric Roulette" project
    Then I should see the unauthorized private project message
    Given the owner of the project "Colcentric Roulette" sent an invitation to "mislav"
    When I go to the page of the "Colcentric Roulette" project
    And I press "Accept"
    Then I should see "Colcentric Roulette"
  ...
  Scenario: Mislav invites a user who belongs to the project's organization
    ...
    And I press "Invite"
    Then "pablo@colcentric.com" should receive an email
    When "pablo@colcentric.com" opens the email
    Then I should see "You are now a member of the project" in the email body
    And I should see "Ruby Rockstars" in the email body

  Scenario: Mislav invites existing colcentric users to a project
  ...
  Scenario: Mislav deletes an invitation that hasnt been accepted
    Given I am logged in as @mislav
    When I go to the people page of the "Ruby Rockstars" project
    And I fill in "invitation_user_or_email" with "charles@colcentric.com"
    And I press "Invite"
    And I follow "Discard invitation"
    And I wait for 1 second
    Then I should not see "charles@colcentric.com"
