...
Background: 
  ...
  And the organization of the project called "Ruby Rockstars" is called "Colcentric Data"
...
Scenario: Mislav imports an historic project
  ...
  And the following confirmed users exist
    ...
    | pablo  | pablo@colcentric.com        | Pablo      | Villalba  |
    | frodo  | frodo@theshire.com       | Frodo      | Baggins   |
    | gandalf| gandalf@middleearth.com  | Gandalf    | Grey      |
  And I follow "Import"
  And I choose "Colcentric"
  And I attach the file "spec/fixtures/colcentricdump.json" to "colcentric_data_import_data"
  ...
  When I select the following:
    ...
    | Put all projects in this organization | Colcentric Data               |
  And I press "Import"
  Then I should see "Imported projects"
  And I should see "Colcentric #1"
...
Scenario: Mislav imports another historic project
  ...
  And I follow "Import"
  And I choose "Colcentric"
  And I attach the file "spec/fixtures/colcentricdump_problem.json" to "colcentric_data_import_data"
  And I press "Import data"
  When I select the following:
...
Scenario: Mislav gets fed up of Basecamp and moves to Colcentric
  When I go to the your data page
  And I follow "Import"
  And I choose "Basecamp"
  And I attach the file "spec/fixtures/campdump.xml" to "colcentric_data_import_data"
  And I press "Import data"
...
Scenario: Mislav imports data with invalid records
  ...
  And I follow "Import"
  And I choose "Colcentric"
  And I attach the file "spec/fixtures/colcentricdump_invalid.json" to "colcentric_data_import_data"
  And I press "Import data"
  Then I should see "Andrew Wiggin (@gandhi_1)"
  And I should see "Andrew Wiggin (@gandhi_2)"
  And I should see "Andrew Wiggin (@gandhi_3)"
