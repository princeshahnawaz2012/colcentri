...
Feature: See tasks in different, common groupings
  ...
  Background: 
    ...
    And the following task lists with associations exist:
      | name      | project        |
      | This week | Market Colcentric |
      | Later     | Market Colcentric |
    And the following tasks with associations exist:
      ...
      | Post on Digg and Hacker News           | This week | Market Colcentric |
      | Beg Apple to approve of the iPhone app | Later     | Market Colcentric |
